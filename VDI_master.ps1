...
# 수정
Powershell "& {Get-AppxProvisionedPackage -Online | Where {$_.DisplayName -NotMatch 'Microsoft.StorePurchaseApp' -and $_.DisplayName -NotMatch 'Microsoft.WindowsStore' -and $_.DisplayName -NotMatch 'Microsoft.MicrosoftEdge.Stable' -and $_.DisplayName -NotMatch 'Microsoft.WindowsCalculator' -and $_.DisplayName -NotMatch 'Microsoft.Windows.Photos' -and $_.DisplayName -NotMatch 'Microsoft.MSPaint' -and $_.DisplayName -NotMatch 'Microsoft.WindowsNotepad' -and $_.DisplayName -NotMatch 'Microsoft.Office.OneNote'} | Remove-AppxProvisionedPackage -Online -AllUsers}"
Powershell "& {Get-AppxPackage -AllUsers | Where-Object {$_.IsFramework -Match 'False' -and $_.NonRemovable -Match 'False' -and $_.Name -NotMatch 'Microsoft.StorePurchaseApp' -and $_.Name -NotMatch 'Microsoft.WindowsStore' -and $_.Name -NotMatch 'Microsoft.MicrosoftEdge.Stable' -and $_.Name -NotMatch 'Microsoft.WindowsCalculator' -and $_.Name -NotMatch 'Microsoft.Windows.Photos' -and $_.Name -NotMatch 'Microsoft.MSPaint' -and $_.Name -NotMatch 'Microsoft.WindowsNotepad' -and $_.Name -NotMatch 'Microsoft.Office.OneNote'} | Remove-AppxPackage -AllUsers}"
